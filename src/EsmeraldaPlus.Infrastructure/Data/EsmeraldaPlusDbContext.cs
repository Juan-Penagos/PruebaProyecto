    ...
    //        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Cliente>(entity =>
            {
                ...
                entity.Property(e => e.CodTelefon)
                    .HasColumnName("Cod_telefon")
                    .HasColumnType("int(11)");
            ...
            modelBuilder.Entity<ComprovantePedido>(entity =>
            {
                ...
                entity.Property(e => e.IdComprovante)
                    .HasColumnName("Id_Comprovante")
                    .HasColumnType("int(11)");
            ...
            modelBuilder.Entity<Insumos>(entity =>
            {
                ...
                entity.Property(e => e.IdProvedor)
                    .HasColumnName("Id_Provedor")
                    .HasColumnType("int(11)");

                entity.Property(e => e.IdTipoDeInsumo)
                    .HasColumnName("Id_Tipo_de_Insumo")
                    .HasColumnType("int(11)");

                entity.Property(e => e.ValorInsumo)
                    .HasColumnName("Valor_insumo")
                    .HasColumnType("int(11)");
            ...
            modelBuilder.Entity<Inventario>(entity =>
            {
                ...
                entity.Property(e => e.IdDelProducto)
                    .HasColumnName("Id_del_producto")
                    .HasColumnType("int(11)");
            ...
            modelBuilder.Entity<Produccion>(entity =>
            {
                ...
                entity.Property(e => e.CantidadInsumos)
                    .HasColumnName("Cantidad_insumos")
                    .HasColumnType("int(11)");
                ...
                entity.Property(e => e.TipoDeProductos)
                    .HasColumnName("Tipo_de_productos")
                    .HasColumnType("int(11)");
            ...
            modelBuilder.Entity<TipoDeProductos>(entity =>
            {
                ...
                entity.Property(e => e.IdTipoDeProductos)
                    .HasColumnName("Id_Tipo_de_productos")
                    .HasColumnType("int(11)");
